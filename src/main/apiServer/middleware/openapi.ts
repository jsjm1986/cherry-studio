...
const swaggerOptions: swaggerJSDoc.Options = {
  definition: {
    ...
    info: {
      title: 'Roome API',
      version: '1.0.0',
      description: 'OpenAI-compatible API for Roome with additional Roome-specific endpoints',
      contact: {
        name: 'Roome',
    ...
    components: {
      securitySchemes: {
        BearerAuth: {
          ...
          scheme: 'bearer',
          bearerFormat: 'JWT',
          description: 'Use the API key from Roome settings'
        }
      },
      schemas: {
        Error: {
...
export function setupOpenAPIDocumentation(app: Express) {
  try {
    ...
    app.use(
      ...
      `,
        customSiteTitle: 'Roome API Documentation'
      })
    )
