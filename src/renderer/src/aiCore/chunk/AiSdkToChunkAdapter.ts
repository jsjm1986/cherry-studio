/**
 * AI SDK 到 Roome Chunk 适配器
 * 用于将 AI SDK 的 fullStream 转换为 Roome 的 chunk 格式
 */
...
/**
 * AI SDK 到 Roome Chunk 适配器类
 * 处理 fullStream 到 Roome chunk 的转换
 */
export class AiSdkToChunkAdapter {
  ...
  /**
   * 读取 fullStream 并转换为 Roome chunks
  ...
  /**
   * 转换 AI SDK chunk 为 Roome chunk 并调用回调
