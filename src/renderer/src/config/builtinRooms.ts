...
export const BUILTIN_ROOMS: BuiltinRoom[] = [
  ...
  // 人类群星房间
  {
    ...
    prompt: MPP_KERNEL + '\n\n' + STARS_ROOM_PROMPT,
    welcomeMessage:
      '汇聚人类群星的智慧，只为解答你的难题。请 @ 专家，听听他的见解。\n\n@ 迷宫-博尔赫斯 分析你的需求，推荐最匹配的咨询专家\n@ 佛学-释衍空 用佛法智慧拆解困境，看清因果纠缠\n@ 系统论-赫尔曼 推演事物演化规律，透视底层模式\n@ 造物主-德米吾尔 审计设定逻辑漏洞，预判推演后果\n@ 思想史-利奥波德 追溯思想脉络，理清观点来龙去脉\n@ 狂想家-V 跨学科思维爆破，打破你的认知常规\n@ 语言学-吉尔伯特 清理语言歧义，确保沟通逻辑纯净\n@ 侧写师-伊索尔德 解析性格代码，定位认知偏好与盲区\n@ 心理学家-伊丽莎白 解读梦境与潜意识，看见真实动机\n@ 现象学-克劳斯 剥离表象干扰，直击问题核心本质\n@ 侦探-沃克 捕捉行为痕迹，还原真实意图与状态\n@ 情报商-霓虹 挖掘被掩盖信息，提供去噪后的真相',
    experts: [
      {
        name: '情报商-霓虹',
        emoji: '🌃',
