...
import { Code, FileSearch, Folder, Languages, LayoutGrid, NotepadText, Palette, Sparkle, Users } from 'lucide-react'
...
const LaunchpadPage: FC = () => {
  ...
  const appMenuItems = [
    ...
    },
    {
      ...
      text: t('hosts.title'),
      path: '/hosts',
      bgColor: 'linear-gradient(135deg, #059669, #10B981)' // 主机：深绿色，代表协作和团队
    },
    {
